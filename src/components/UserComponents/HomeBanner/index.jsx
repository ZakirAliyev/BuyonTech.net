...
import arxaVideo from "/src/assets/arxaVideo.mp4"
            ...
            <div className="container">
                <div className="wrapper">
                    ...
                    <video autoPlay muted loop playsInline className="bg-video">
                        <source src={`${arxaVideo}`} type="video/mp4" />
                    </video>

                    <div className="content">
                        <h2>{t("siteRoot.homePage.homeBanner.title")}</h2>
                        <p>{t("siteRoot.homePage.homeBanner.text")}</p>
                        <button onClick={() => {
